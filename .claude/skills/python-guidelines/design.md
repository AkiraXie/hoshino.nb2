...
> Distilled from the **Google Python Style Guide**
> Source: <https://google.github.io/styleguide/pyguide.html>
> License: Apache License 2.0 (redistributed with attribution)

Every rule below is a design-level constraint that a linter cannot fully
