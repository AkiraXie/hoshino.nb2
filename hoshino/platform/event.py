...
class EventBackend(Protocol):
    ...
    def get_event_message(self, event: Event, default: Any = None) -> MessageLike | None: ...
    def get_plaintext(self, event: Event, default: str = "") -> str: ...
    def get_session_id(self, event: Event, default: str | None = None) -> str | None: ...
    def get_message_id(self, event: Event, default: Any = None) -> MessageId | None: ...
    def get_reply_message(self, event: Event, default: Any = None) -> MessageLike | None: ...
    def get_reply_sender_id(self, event: Event, default: str | None = None) -> str | None: ...
    def get_reply_message_id(self, event: Event, default: Any = None) -> MessageId | None: ...
    ...
    async def get_forwarded_messages(self, bot: Bot, event: Event) -> list[MessageLike]: ...
