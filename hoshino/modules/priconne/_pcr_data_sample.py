CHARA_NAME = {
    ...
    1020: ["美美", "ミミ", "Mimi", "兔子", "兔兔", "萝卜霸断剑", "人参霸断剑", "天兔霸断剑", "🐇", "🐰", "兔剑"],
    ...
    1067: ["穗希", "ホマレ", "Homare"],
    1068: ["拉比林斯达", "ラビリスタ", "Rabirisuta", "迷宫女王", "模索路晶", "模索路", "晶", "晶姐", "王晶"],
    1069: ["真那", "マナ", "Mana", "霸瞳皇帝", "霸瞳", "千里真那", "霸铜"],
    1070: ["似似花", "ネネカ", "Neneka", "变貌大妃", "nnk", "448", "捏捏卡", "变貌", "大妃"],
    1071: ["克莉丝提娜", "クリスティーナ", "Kurisutiina", "Christina", "Cristina", "誓约女君", "克总", "女帝", "克", "克里斯蒂娜"],
    ...
    1076: ["可可萝(夏日)", "コッコロ(サマー)", "Kokkoro(Summer)", "水白", "水可", "水可可", "水可可萝", "水可可罗", "泳装可可萝", "泳装可可罗", "水妈"],
    ...
    1085: ["胡桃(圣诞节)", "クルミ(ク リスマス)", "Kurumi(Xmas)", "圣诞胡桃", "圣诞铃铛"],
    ...
    1089: ["怜(新年)", "レイ(ニューイヤー)", "Rei(NewYear)", "春剑", "春怜", "春伶", "新剑"],
    ...
    1093: ["露", "ルゥ", "Ruu", "逃课女王"],
    1094: ["古蕾娅", "グレア", "Gurea", "龙姬", "古雷娅", "古蕾亚", "古雷亚", "🐲🐔", "🐉🐔", "龙女"],
    ...
    1110: ["优妮", "ユニ", "Yuni", "u2", "优妮辈先", "辈先", "书记", "油腻", "尤尼", "尤妮", 'uni', 'un'],
    ...
    1118: ["贪吃佩可(新年)", "ペコリーヌ(ニューイヤー)", "Pecoriinu(NewYear)", "春吃", "新吃", "春节佩可", "春节吃货", "新年吃货", "新年佩可", "新佩", "春佩","年货"],
    1119: ["可可萝(新年)", "コッコロ(ニューイヤー)", "Kokkoro(NewYear)", "春可可", "春白", "新年妈", "春妈"],
    1120: ["凯留(新年)", "キャル(ニューイヤー)", "Kyaru(NewYear)", "春凯留", "春黑猫", "春黑", "春臭鼬", "新年凯留", "新年黑猫", "新年臭鼬", "唯一神", "新黑"],
    1121: ["铃莓(新年)", "スズメ(ニューイヤー)", "Suzume(NewYear)", "春铃莓", "春女仆", "春妹抖", "新年铃莓", "新年女仆", "新年妹抖"],
    1122: ["霞(魔法少女)", "カスミ(マジカル)", "Kasumi(Magical)", "魔法少女霞", "魔法侦探", "魔法杜宾犬", "魔法驴", "魔法驴子", "魔驴", "魔法霞", "魔法少驴"],
    1123: ["栞(魔法少女)", "シオリ(マジカル)", "Shiori(Magical)", "魔法少女栞", "魔法tp弓",  "魔法小栞", "魔法白虎弓", "魔法白虎妹", "魔法白虎"],
    1124: ["卯月(偶像大师)", "ウヅキ(デレマス)", "Udsuki(DEREM@S)", "卯月", "卵用", "Udsuki(DEREMAS)", "岛村卯月", "卯月(NGs)"],
    1125: ["凛(偶像大师)", "リン(デレマス)", "Rin(DEREM@S)", "凛", "Rin(DEREMAS)", "涩谷凛", "西部凛", "凛(NGs)"],
    1126: ["未央(偶像大师)", "ミオ(デレマス)", "Mio(DEREM@S)", "未央", "Mio(DEREMAS)", "本田未央", "未央(NGs)"],
    1127: ["铃(游侠)", "リン(レンジャー)", "Rin(Ranger)", "铃(游骑兵)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠🐿️", "武松"],
    1128: ["真阳(游侠)", "マヒル(レンジャー)", "Mahiru(Ranger)", "真阳(游骑兵)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮", "牛叉"],
    1129: ["璃乃(奇幻)", "リノ(ワンダー)", "Rino(Wonder)", "璃乃(仙境)", "爽弓", "爱丽丝弓", "爱弓", "兔弓", "奇境妹弓", "仙境妹弓", "白丝妹弓", "璃乃(奇境)"],
    1130: ["步未(奇幻)", "アユミ(ワンダー)", "Ayumi(Wonder)", "步未(仙境)", "路人兔", "兔人妹", "爱丽丝路人", "奇境路人", "仙境路人", "步未(奇境)"],
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水流夏", "水大姐头", "水大姐", "泳装大姐头", "泳装流夏", "流夏(泳装)", "水亚索", "泳装亚索"],
    ...
    1138: ["依里(天使)", "ヨリ(エンジェル)", "Yori(Angel)", "天使依里", "天使姐姐法", "天使姐法"],
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "万圣蜘蛛侠", "🎃🕷️", "🎃🕸️", "万裁", "瓜裁", "鬼裁", "鬼才"],
    1140: ["怜(万圣节)", "レイ(ハロウィン)", "Rei(Halloween)", "万圣剑圣", "万剑", "瓜剑", "万圣怜", "鬼剑士", "鬼剑"],
    1141: ["茉莉(万圣节)", "マツリ(ハロウィン)", "Matsuri(Halloween)", "万圣跳跳虎", "万圣老虎", "瓜虎", "🎃🐅"],
    1142: ["莫妮卡(魔法少女)", "モニカ(マジカル)", "Monika(Magical)", "魔法少女莫妮卡", "魔二力", "魔法少女毛二力", "魔法毛二力"],
    1143: ["智(魔法少女)", "トモ(マジカル)", "Tomo(Magical)", "魔法少女智", "琪露诺", "9智", "9", "魔法智"],
    1144: ["秋乃(圣诞节)", "アキノ(クリスマス)", "Akino(Xmas)", "圣剑", "生煎", "圣诞哈哈剑", "哈哈剑(圣诞节)", "圣哈", "蛋哈", "蛋剑"],
    1145: ["咲恋(圣诞节)", "サレン(クリスマス)", "Saren(Xmas)", "圣诞充电宝", "圣诞咲恋", "圣诞电宝", "圣电", "圣诞电", "圣诞充电", "圣诞充", "圣充"],
    1146: ["优花梨(圣诞节)", "ユカリ(クリスマス)", "Yukari(Xmas)", "蛋黄", "由加莉(圣诞节)", "圣诞黄骑", "圣诞圣骑", "蛋骑", "黄骑(圣诞节)"],
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)", "春节511", "新年511", "新年无意义", "春节无意义"],
    
    
            
        
    1150: ["似似花(新年)","ネネカ(ニューイヤー)","Neneka(NewYear)","春花","春nnk","新nnk","新花","新年似似花","春节似似花"],
    # =================================== #
    
    1701: ["环奈", "カンナ", "Kanna", "桥本环奈", "毛大力", "毛小力", "毛六力", "可大萝", "大可萝", "缝合怪", "一环", "大环"],
    1702: ["环奈(振袖)", "カンナ(振り袖)", "Kanna(Furisode)", "桥本环奈(振袖)", "二环", "振袖环奈", "振环", "春环", "新环","甄嬛"],
    
    # =================================== #
    
    1801: ["日和(公主)", "ヒヨリ(プリンセス)", "Hiyori(Princess)", "公主猫拳", "公猫", "公主日和", "掉毛猫"],
    1802: ['优衣(公主)', "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主优衣", "掉毛", "飞翼", "飞翼高达", "公田", "毛衣", "公主ue"],
    1804: ["贪吃佩可(公主)", "ペコリーヌ(プリンセス)", "Pekoriinu(Princess)", "公主吃", "公主饭", "公主吃货", "公主佩可", "公主饭团", "公主🍙", "命运高达", "高达", "命运公主", "高达公主", "春哥高达", "🤖🍙", "🤖"],
    1805: ["可可萝(公主)", "コッコロ（プリンセス）", "Kokkoro(Princess)", "公主妈", "月光妈", "蝶妈", "蝴蝶妈", "月光蝶妈", "公主可", "公主可萝", "公主可可萝", "月光可", "月光可萝", "月光可可萝", "蝶可", "蝶可萝", "蝶可可萝", "月光蝶"],
