...
from .. import _deps as ai_deps
from .. import _persona as persona, _skills as skills, _tools as tools
from .._base import get_config, resolve_provider, sv
...
def ai_store_get_scope_persona(scope_key: str) -> int | None:
    ...
    from .. import _store as ai_store
